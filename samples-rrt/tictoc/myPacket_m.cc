...
::omnetpp::simtime_t MyPacket::getInitTime() const
{
    return this->initTime;
}

void MyPacket::setInitTime(::omnetpp::simtime_t initTime)
{
    this->initTime = initTime;
}

int MyPacket::getFlowId() const
{
    return this->flowId;
}

void MyPacket::setFlowId(int flowId)
{
    this->flowId = flowId;
}

int MyPacket::getFlowSeqNum() const
{
    return this->flowSeqNum;
}

void MyPacket::setFlowSeqNum(int flowSeqNum)
{
    this->flowSeqNum = flowSeqNum;
}

int MyPacket::getLinkSeqNum() const
{
    return this->linkSeqNum;
}

void MyPacket::setLinkSeqNum(int linkSeqNum)
{
...
std::string MyPacketDescriptor::getFieldValueAsString(void *object, int field, int i) const
{
    ...
    MyPacket *pp = (MyPacket *)object; (void)pp;
    switch (field) {
        case 0: return simtime2string(pp->getInitTime());
...
bool MyPacketDescriptor::setFieldValueAsString(void *object, int field, int i, const char *value) const
{
    ...
    MyPacket *pp = (MyPacket *)object; (void)pp;
    switch (field) {
        case 0: pp->setInitTime(string2simtime(value)); return true;
